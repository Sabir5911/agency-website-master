...
const Testimonial = () => {
  ...
  return (
    <div className=" text-white py-16 px-6 md:px-20 flex flex-col items-center  mt-16 h-[400px] font-roboto">
      ...
      <div className="flex items-center mt-8 max-w-4xl">
        <button onClick={prevTestimonial} className="mr-20  border p-2  rounded-full  hover:bg-[#0cc0df]">
          <FaArrowLeft className=" "  color="none"/>
        </button>
          ...
          >
            ...
            <div className="md:ml-6 mt-4 md:mt-0">
             ...
             <blockquote className="mt-6   italic">
              {testimonials[index].text}</blockquote>
        ...
        <button onClick={nextTestimonial} className=" ml-20 border p-2  rounded-full mr-4 hover:bg-[#0cc0df]">
          <FaArrowRight className=" "  color="none"/>
        </button>
